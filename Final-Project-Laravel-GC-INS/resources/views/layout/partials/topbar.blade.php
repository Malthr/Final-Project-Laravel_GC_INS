        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle show" data-bs-toggle="dropdown">
                    <img src="{{ asset($user->profil_pic ? 'storage/' . $user->profil_pic : 'img/default-profile.png') }}" class="user-image rounded-circle" alt="Profile Picture">
                </a>

                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <li class="user-header"> 
                        <img src="{{ asset($user->profil_pic ? 'storage/' . $user->profil_pic : 'img/default-profile.png') }}" class="user-image rounded-circle" alt="">
